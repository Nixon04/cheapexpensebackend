        ...
        <div class="flex-wrap-container">
            ...
            <div class="aside-navigation">
                <ul class="ul-flex">
                    ...
                    <!-- <Link href="/vendorspath/dashboard/invoices" class="mb-4">
                        <li :class="['mealxpress-navlink', { active: $page.url === '/vendorspath/dashboard/invoices' } ]">
                            <i class="fa-regular fa fa-file-lines mealxpress-icons" ></i>
                            invoices
                        </li>
                    </Link>
                    ...
                    <Link href="/vendorspath/dashboard/delivery" class="mb-4">
                        <li :class="['mealxpress-navlink', { active: $page.url === '/vendorspath/dashboard/delivery' } ]">
                            <i class=" fa fa-car-side mealxpress-icons" ></i>
                            Delivery
                        </li>
                    </Link> -->
